...
import { UserSignupInput } from "@anvesh-singh/common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    <LabelledInput label="FirstName" placeholder="Anvesh" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                    ...
                    <LabelledInput label="DOB" placeholder="06/10/2004" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            DOB: e.target.value
                        })
                    }} />
                    <LabelledInput label="Email" placeholder="anveshsingh@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            Email: e.target.value
                        })
                    }} />
                    <LabelledInput label="Phone" placeholder="+91XXXXXXXXXX" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
