...
import { PatientSignupInput } from "@anvesh-singh/common";
...
export const UserAuthsignup = () => {
  ...
  const [postInputs, setPostInputs] = useState<PatientSignupInput>({
    FirstName: "",
    LastName: "",
    DOB: "",
    Email: "",
      ...
      <div className="flex justify-center">
        <div>
          ...
          <div className="text-3xl flex gap-4 items-center font-light tracking-wider py-4 border-b-[1px] border-gray-500 mb-8">
            <Link to="/signin" className="hover:scale-x-110"><TiArrowBackOutline /></Link>              Create an account as User
            </div>
