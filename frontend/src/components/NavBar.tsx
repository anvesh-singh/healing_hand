...
export function NavBar() {
  ...
  return (
    ...
    //     <img src="https://image.similarpng.com/very-thumbnail/2020/08/Medical-team-design-on-transparent-background-PNG.png" alt="" />
    //   </div>
    //   <div className="">
    //   <div className='links'>
    //     {["Book Appointment","Consult Online","View Health Record","Find Hospital","icon"].map((item,index)=>(
    //       <a key={index} className={`  text-lg ml-20 capitalize font-light text-white hover:text-green-200 visited:text-green-600 ${index===4 && "ml-64"}`}>{item}</a>
    //     ))}
...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 " style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate3d(358px, 62px, 0px)' }} id="user-dropdown" data-popper-placement="bottom">
